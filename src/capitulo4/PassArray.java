...
public class PassArray {
	...
	public static void main(String[] args) {
		...
		modifyElement(array[3]); // tenta modificar o array[3] //Depois que é executado este método, os parametros do método criado é destruído, por isso o valor retornado é 8.
